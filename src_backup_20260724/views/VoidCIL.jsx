              ...
              <div className="detail-panel-body">
                ...
                {selected.items.map((it, i) => (
                  <div key={i} style={{
                    ...
                    background:'var(--card)', borderRadius:10, marginBottom:8,
                  }}>
                    <div style={{
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  ...
                  {selected.status === 'completed' && (
                    <div style={{
                      ...
                      border:'1px solid rgba(0,108,53,0.25)', borderRadius:8,
                  ...
                  {selected.status === 'rejected' && (
                    <div style={{
                      ...
                      border:'1px solid rgba(197,0,26,0.25)', borderRadius:8,
