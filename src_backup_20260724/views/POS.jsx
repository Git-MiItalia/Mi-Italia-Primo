  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal modal-sm" onClick={e => e.stopPropagation()}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'10px 13px', background:'var(--card)', borderRadius:10, marginBottom:14 }}>
          <div>
  ...
  return (
    <div className="pos-layout">
      ...
      <div className="pos-items">
        ...
        {/* Customer lookup */}
        <div style={{ background:'rgba(184,149,90,0.04)', border:'1.5px solid rgba(184,149,90,0.15)', borderRadius:14, padding:'12px 14px', marginBottom:12 }}>
          <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:0 }} ref={dropdownRef}>
            <div style={{ flex:1, position:'relative' }}>
              <div style={{ display:'flex', alignItems:'center', gap:7, padding:'8px 12px', background:'var(--white)', border:'1.5px solid var(--mist)', borderRadius:10 }}>
              ...
              {showDropdown && searchResults.length > 0 && (
                <div style={{ position:'absolute', top:'calc(100% + 4px)', left:0, right:0, background:'var(--white)', border:'1.5px solid var(--mist)', borderRadius:10, boxShadow:'0 4px 20px rgba(26,18,9,0.12)', zIndex:50, overflow:'hidden' }}>
                  {searchResults.map((r, i) => (
                    ...
                    >
                      ...
                      <span style={{ padding:'1px 7px', borderRadius:5, fontSize:8, fontWeight:600, background: r.source === 'returning' ? 'rgba(0,108,53,0.1)' : 'rgba(184,149,90,0.1)', color: r.source === 'returning' ? 'var(--green)' : 'var(--gold)' }}>
          ...
          {customer && !isWalkIn && (
            <div style={{ marginTop:10 }}>
              <div style={{ background:`linear-gradient(135deg,${gradFrom},rgba(255,255,255,0))`, border:`1.5px solid ${borderColor}`, borderRadius:12, overflow:'hidden' }}>
                <div style={{ padding:'12px 14px', display:'flex', alignItems:'center', gap:12 }}>
                  ...
                  <div style={{ flex:1 }}>
                    <div style={{ display:'flex', alignItems:'center', gap:6 }}>
                      ...
                      {tier && <span style={{ padding:'1px 7px', borderRadius:5, background:ts.bg, color:ts.color, fontSize:8, fontWeight:700 }}>{tier.toUpperCase()}</span>}
                      <span style={{ padding:'1px 7px', borderRadius:5, background: isReturning ? 'rgba(0,108,53,0.1)' : 'rgba(184,149,90,0.1)', color: isReturning ? 'var(--green)' : 'var(--gold)', fontSize:8, fontWeight:600 }}>
                ...
                <div style={{ borderTop:`1px solid ${dividerColor}`, padding:'10px 14px', background:'rgba(255,255,255,0.5)' }}>
                  ...
                  <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:8, marginBottom:10 }}>
                    {[
                      ...
                      <div key={s.lbl} style={{ background:'var(--white)', borderRadius:9, padding:'8px 10px', textAlign:'center', border:'1px solid var(--mist)' }}>
                ...
                <div style={{ borderTop:`1px solid ${dividerColor}`, padding:'10px 14px', display:'flex', gap:8 }}>
                  ...
                  <button className="btn btn-sm" style={{ background:'#25D366', color:'white', flex:1, justifyContent:'center', borderRadius:9, padding:'5px 12px', fontSize:10, fontWeight:600, display:'flex', alignItems:'center', gap:5 }}
          ...
          {customer && isWalkIn && (
            <div style={{ marginTop:10, display:'flex', alignItems:'center', justifyContent:'space-between', padding:'10px 14px', background:'rgba(99,91,255,0.05)', border:'1.5px solid rgba(99,91,255,0.15)', borderRadius:12 }}>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:14 }}>
          <div style={{ flex:1, display:'flex', alignItems:'center', gap:6, padding:'8px 12px', background:'var(--card)', borderRadius:10 }}>
          ...
          {!prodLoading && products.map(p => (
            <div key={p.id} className="pos-product" onClick={() => openProduct(p)}>
              ...
              {parseInt(p.total_stock) === 0 && (
                <div style={{ position:'absolute', inset:0, background:'rgba(255,255,255,0.7)', borderRadius:10, display:'flex', alignItems:'center', justifyContent:'center', fontSize:10, fontWeight:600, color:'var(--red)' }}>Out of stock</div>
              )}
            </div>
          ))}
        ...
        {cart.length > 0 && (
          <div className="pos-cart-footer">
            ...
            <div style={{ marginBottom:10 }}>
              <div style={{ display:'flex', alignItems:'center', gap:8, padding:'7px 10px', background:'var(--card)', borderRadius:8 }}>
            ...
            {/* Payment tabs */}
            <div style={{ display:'flex', gap:5, background:'var(--mist)', borderRadius:10, padding:4, marginBottom:12 }}>
              {[
            ...
            {payTab === 'external' && (
              <div>
                <div style={{ background:'rgba(99,91,255,0.05)', border:'1.5px solid rgba(99,91,255,0.15)', borderRadius:10, padding:12, marginBottom:10 }}>
            ...
            {payTab === 'cash' && (
              <div>
                <div style={{ background:'rgba(0,108,53,0.05)', border:'1.5px solid rgba(0,108,53,0.15)', borderRadius:10, padding:12, marginBottom:10 }}>
