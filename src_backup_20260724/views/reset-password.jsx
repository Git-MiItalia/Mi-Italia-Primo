      ...
      <div className="auth-form-panel">
        <div className="auth-form-inner">
          ...
          <h2 className="auth-title">
            Reset <em className="auth-title-em">New Password</em>
          </h2>
          <p className="auth-subtitle">Enter a new password to access your account</p>

          {error   && <div className="alert alert-urgent auth-alert">{error}</div>}
          {success && <div className="alert alert-info auth-alert">Redirecting to login…</div>}
