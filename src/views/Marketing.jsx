...
function CampaignBuilder({ campaignId: initialId, segments: segArr, onBack, onReview }) {
  ...
  return (
    <div className="camp-sub-wrap">
      ...
      {errorMsg && (
        <div style={{ padding:'10px 14px', background:'rgba(197,0,26,0.06)', border:'1px solid rgba(197,0,26,0.3)', borderRadius: 0, fontSize:11, color:'var(--red)', marginBottom:12 }}>{errorMsg}</div>
      )}
...
function CampaignReview({ campaignId, onBack, onSubmit }) {
  ...
  return (
    <div className="camp-sub-wrap">
      ...
      {successMsg && (
        <div style={{ padding:'10px 14px', background:'rgba(0,108,53,0.06)', border:'1px solid rgba(0,108,53,0.3)', borderRadius: 0, fontSize:11, color:'var(--green)', marginBottom:12 }}>{successMsg}</div>
      )}
    ...
    <>
      ...
      <div className="cam-modal" role="dialog" aria-modal="true">
        ...
        <div className="cam-modal-body">
          ...
          {errorMsg && (
            <div style={{ padding:'12px 14px', background:'rgba(197,0,26,0.06)', border:'1px solid rgba(197,0,26,0.3)', borderRadius: 0, fontSize:11, color:'var(--red)', marginBottom:14 }}>{errorMsg}</div>
          )}
  ...
  return (
    <span style={{ display:'inline-flex', alignItems:'center', gap:6 }}>
      <span style={{
        ...
        border:'1.2px solid var(--gold)', borderRadius: 0, fontSize:8, fontWeight:700,
...
function AnalyticsView() {
  ...
  return (
    <div>
      ...
      {/* ── Footer note ── */}
      <div style={{ background:'rgba(184,149,90,0.05)', border:'1px solid rgba(184,149,90,0.18)', borderRadius: 0, padding:'12px 16px', display:'flex', alignItems:'flex-start', gap:10, fontSize:10.5, color:'var(--gold-dk)', lineHeight:1.55 }}>
